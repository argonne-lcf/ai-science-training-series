...
prof.export_chrome_trace(f"{args.trace_dir}/cuda_pt_2p8_compile-{RANK}-of-{SIZE}.json")
output_path = f"{args.trace_dir}/cuda_pt_2p8_compile_self_cuda_time_total-{RANK}-of-{SIZE}.txt"
